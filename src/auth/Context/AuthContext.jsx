...
//   const scheduleAutoLogout = (exp, currentTime) => {
...
//       const response = await axios.post("http://10.11.5.23:5268/api/Auth/refresh-token", { refreshToken });
...
//   return (
//     <AuthContext.Provider value={{ auth, handleLogin, handleLogout, refreshAuthToken }}>
//       {children}
